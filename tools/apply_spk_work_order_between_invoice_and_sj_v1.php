...
/*
|--------------------------------------------------------------------------
| SPK Work Order Between Invoice and Surat Jalan V1
|--------------------------------------------------------------------------
|
| Final architecture:
|
...
if (
    ...
    fwrite(
        STDERR,
        "Expected 1 Invoice Blade containing legacy Generate Surat Jalan route, found "
        .count(
            $invoiceViewCandidates
        )
        .".\n"
    ...
    foreach ($invoiceViewCandidates as $candidate) {
        fwrite(
            STDERR,
            " - {$candidate}\n"
        );
...
echo "\n";
echo "SPK Work Order V1 installer selesai.\n";
